...
<section id="portfolio">
    <div class="container">
        <div class="text-center">
            ...
            <p class="lead" id="recentWorksBodyText">Browse our portfolio of our latest energy efficiency projects. Installing new roofs or solar panels, energy efficient windows and door always makes us happy. We know the owners will benefit from energy savings for years to come.</p>
        </div>
        ...
        <div class="row" style="margin-left:auto; margin-right:auto;">
            <div class="portfolio-items">
                ...
                <div class="portfolio-item windowsDoors col-xs-12 col-sm-4 col-md-3">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('images/portfolio/recent/bronze-windows-3-290.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3 style="color:#ffffff;">Windows &#38; Doors</h3>
                                <a class="preview" href="{{url('images/portfolio/full/bronze-windows-3-full.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item windowsDoors col-xs-12 col-sm-4 col-md-3">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('images/portfolio/recent/window_bronze-2-290.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3 style="color:#ffffff;">Windows &#38; Doors</h3>
                                <a class="preview" href="{{url('images/portfolio/full/window_bronze-2.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                <div class="portfolio-item windowsDoors col-xs-12 col-sm-4 col-md-3">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('images/portfolio/recent/window-replacement-condos-pacific-beach.jpg')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3 style="color:#ffffff;">Windows &#38; Doors</h3>
                                <a class="preview" href="{{url('images/portfolio/full/window-replacement-condos-pacific-beach.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item fans col-xs-12 col-sm-4 col-md-3">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('images/portfolio/recent/attic-fan-290.png')}}" alt="Attic House Fans">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3 style="color:#ffffff;">Whole house fans </br>Comming soon!</h3>
                                <a class="preview" href="{{url('images/portfolio/full/attic-fan.png')}}" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
