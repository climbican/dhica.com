        ...
        <div class="container">
                ...
                <div class="post__list_item">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="post__introduction">As one of the first blogging platform, Blogger has largely contributed to the spread of blogging in the 90s and early 2000s. Since it&#39;s had been acquired by the giant Google, it has evolved to being one of the best platform to host a business-related blog for several reasons.
            ...
            <div style="margin: 5px;">
                <div class="post__list_item">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="post__title post__title--list">Colour options  need to work on this section</h2>
