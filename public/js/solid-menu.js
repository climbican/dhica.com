			...
			if (this.$owl_carousel.length > 0) {
				...
				this.$owl_carousel.each(function() {
					...
					var single_item = Boolean(_this.attr('data-single-item'));
	   		 		var items_no = _this.attr('data-items') ? Number(_this.attr('data-items')) : 8;
	    			...
	    			var items_lg = _this.attr('data-items-lg') ? Number(_this.attr('data-items-lg')) : 8;
	    			var items_md = _this.attr('data-items-md') ? Number(_this.attr('data-items-md')) : 8;
	    			var items_sm = _this.attr('data-items-sm') ? Number(_this.attr('data-items-sm')) : 4;
	    			var items_xs = _this.attr('data-items-xs') ? Number(_this.attr('data-items-xs')) : 2;
	    			...
	    			if (single_item == true) {
	    				...
	    				_this.owlCarousel({
							...
							/** MY ADD addClassActive  this is for the add active class to trigger  the text animation **/
		    			_this.owlCarousel({
		    				lazyLoad: true,
		    				//items: items_no,
		    				navigation: navigation_value,
...
$(document).ready(function() {
    ...
    $("#window-options-selector").owlCarousel({

        autoPlay: 93000, //Set AutoPlay to 3 seconds
    ...
    $("#door-options-selector").owlCarousel({
